    ...
    public static void main(String[] args) {
        ...
        for (int i = 0;i<n;i++){
            for(int j = 0;j<m;j++){
                ...
                if(j!= 0)  
                matrix[0][j] = 0;
                //if j = 0 , means marking for the row marker column , so it will change the matrix[0][0] value to 0 , but we have the col0 variable as the marker for the j = 0 column.s
                else
                col0 = 0;
            }
        }
